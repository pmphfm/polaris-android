...
abstract class SmartSearchItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    SmartSearchItemHolder(API api, PlaybackQueue playbackQueue, SmartSearchAdapter adapter, View itemView, View itemQueueStatusView) {
        super(itemView);
    ...
    public void onClick(View view) {
        if (item.isDirectory()) {
            ...
            args.putSerializable(SmartSearchFragment.NAVIGATION_MODE, SmartSearchFragment.NavigationMode.PATH);
            args.putString(SmartSearchFragment.PATH, item.getPath());
            Navigation.findNavController(view).navigate(R.id.nav_smart_search, args);
        }
    }
